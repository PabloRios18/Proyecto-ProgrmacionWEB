                ...
                <div class="ficha">
                    ...
                    <div class="estado-actividades">
                        ...
                        <div class="enlace">
                            ...
                            <a href="${items.actividades[6].linkA}">${items.actividades[6].actividad}</a>
                            <a href="${items.actividades[7].linkA}">${items.actividades[7].actividad}</a>
                            <a href="${items.actividades[8].linkA}">${items.actividades[8].actividad}</a>
                        </div>
                        <div class="porcentajeuiux">
                            ...
                            <p>${items.actividades[6].estadouiux}</p>
                            <p>${items.actividades[7].estadouiux}</p>
                            <p>${items.actividades[8].estadouiux}</p>
                        </div>
                        <div class="porcentajedev">
                            ...
                            <p>${items.actividades[6].estadotecnico}</p>
                            <p>${items.actividades[7].estadotecnico}</p>
                            <p>${items.actividades[8].estadotecnico}</p>
                        </div>
                    </div>
                    </div>
